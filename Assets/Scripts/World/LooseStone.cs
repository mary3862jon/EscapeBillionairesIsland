...
namespace Spoonacci
{
    ...
    public class LooseStone : MonoBehaviour
    {
        ...
        {
            if (promptStyle == null)
                promptStyle = new GUIStyle(GUI.skin.label) { fontSize = UiScale.Font(26), fontStyle = FontStyle.Bold, alignment = TextAnchor.MiddleCenter, normal = { textColor = Color.white } };
        }
    }
}
